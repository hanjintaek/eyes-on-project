        ...
        segment: {
          ...
          backgroundColor: context => {
            ...
            if (xval < nowtempIndex){
              ...
              else if (yval >= 30 ){ return 'rgba(255, 206, 86, 0.2)' }
      ...
      <div className='detail_top_container'>
        ...
        <div className='video_container dark_bg_03'>
            ...
            <div className='video_wrapper'>
              ...
              <img src={`http://127.0.0.1:5000/video`} width={'640px'} height={'480px'} ></img>
            </div>
            {/* hd */}
            <div className='video_wrapper'>
              {/* <video src="/videos/video_1_type_hd.mp4" autoPlay loop muted playsInline></video> */}
              <img src="http://127.0.0.1:5000/video2" width={'640px'} height={'480px'} ></img>
            </div>
        </div>       
      {/* info */}
        ...
        <div className='chart_container dark_bg_03'>
          ...
          <div className='obj_avg_txt white_txt_01'>
              <h4><span className={`chart_legend_circle nor_circle`}></span> 정상 : 30°C 이하</h4>
